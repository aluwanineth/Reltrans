...
import { rtuser } from 'src/app/rt-user';
...
export class SideNavigationMenuComponent implements AfterViewInit, OnDestroy {
  ...
  get items() {
    if (!this._items) {
      ...
      else if(this.userRole.includes('RT User')){
        this._items = rtuser.map((item) => ({ ...item, expanded: !this._compactMode }));
     }
    }
  ...
  constructor(private elementRef: ElementRef, private authenticationService: AuthService) { 
