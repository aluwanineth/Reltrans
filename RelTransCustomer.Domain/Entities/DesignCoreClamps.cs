...
public partial class DesignCoreClamps
{
    ...
    public string? CoilSuppGbmaterial { get; set; }

    public double? CoilSuppGbgauge { get; set; }

    public double? CoilSuppGblength { get; set; }

    public double? CoilSuppGbwidth { get; set; }

    public double? StiffenerBotWidth { get; set; }

    public double? StiffenerHeight { get; set; }

    public double? StiffenerGauge { get; set; }

    public double? StiffenerTopWidth { get; set; }

    public string? StiffenerProfile { get; set; }

    public string? VerTieNutsMaterial { get; set; }

    public int? VerTieNutsQty { get; set; }

    public string? HorTieNutsMaterial { get; set; }

    public int? HorTieNutsQty { get; set; }

    public string? ClampsFeetPaint { get; set; }

    public float? ClampsFeetPaintLiters { get; set; }

    public float? ClampsFeetPaintMicrons { get; set; }
}
