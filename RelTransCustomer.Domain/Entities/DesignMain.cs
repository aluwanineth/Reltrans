...
public partial class DesignMain
{
    ...
    public int? DoveRadialQty { get; set; }

    public float? DoveStack { get; set; }

    public bool? DoveFlip { get; set; }
    ...
    public bool? ConsDrainEnable { get; set; }

    public bool? TmpConsDrainEnable { get; set; }
    ...
    public bool? PublishLock { get; set; }

    public bool? Odauto { get; set; }

    public int? TbmountingRodQty { get; set; }

    public float? TbmountingRodGauge { get; set; }

    public float? TbmountRodLength { get; set; }

    public string? TbmountRodMaterial { get; set; }

    public int? TbmountNutQty { get; set; }

    public float? Tbclearance { get; set; }

    public int? ProductRangeId { get; set; }

    public string? RevNotes { get; set; }

    public bool? Cwimport { get; set; }

    public string? CwimportSpec { get; set; }

    public DateTime? CwimportDate { get; set; }

    public int? SubAssyId { get; set; }

    public string? Wtitype { get; set; }

    public int? Wtiqty { get; set; }
    ...
    public string? Cg1material { get; set; }

    public float? Cg1gauge { get; set; }

    public float? Cg1qty { get; set; }

    public string? Cg1position { get; set; }

    public float? Cg1width { get; set; }

    public float? Cg1length { get; set; }

    public string? Cg2material { get; set; }

    public float? Cg2gauge { get; set; }

    public float? Cg2qty { get; set; }

    public string? Cg2position { get; set; }

    public float? Cg2width { get; set; }

    public float? Cg2length { get; set; }

    public string? Cg3material { get; set; }

    public float? Cg3gauge { get; set; }

    public float? Cg3qty { get; set; }

    public string? Cg3position { get; set; }

    public float? Cg3width { get; set; }

    public float? Cg3length { get; set; }

    public string? Cg4material { get; set; }

    public float? Cg4gauge { get; set; }

    public float? Cg4qty { get; set; }

    public string? Cg4position { get; set; }

    public float? Cg4width { get; set; }

    public float? Cg4length { get; set; }

    public string? Cg5material { get; set; }

    public float? Cg5gauge { get; set; }

    public float? Cg5qty { get; set; }

    public string? Cg5position { get; set; }

    public float? Cg5width { get; set; }

    public float? Cg5length { get; set; }

    public string? Cg6material { get; set; }

    public float? Cg6gauge { get; set; }

    public float? Cg6qty { get; set; }

    public string? Cg6position { get; set; }

    public float? Cg6width { get; set; }

    public float? Cg6length { get; set; }

    public string? TboardBmaterial { get; set; }

    public float? TboardBgauge { get; set; }

    public float? TboardBwidth { get; set; }

    public float? TboardBheight { get; set; }

    public string? TboardBpos { get; set; }

    public string? TboardBrodSize { get; set; }

    public float? TboardBrodLength { get; set; }

    public int? TboardBrodQty { get; set; }

    public float? TboardBclearance { get; set; }

    public float? TboardBrodGauge { get; set; }

    public int? TboardBnutQty { get; set; }

    public string? CoverAmaterial { get; set; }

    public float? CoverAgauge { get; set; }

    public float? CoverAwidth { get; set; }

    public float? CoverAheight { get; set; }

    public string? CoverApos { get; set; }

    public string? CoverArodSize { get; set; }

    public float? CoverArodLength { get; set; }

    public int? CoverArodQty { get; set; }

    public float? CoverAclearance { get; set; }

    public float? CoverArodGauge { get; set; }

    public int? CoverAnutQty { get; set; }

    public string? CoverBmaterial { get; set; }

    public float? CoverBgauge { get; set; }

    public float? CoverBwidth { get; set; }

    public float? CoverBheight { get; set; }

    public string? CoverBpos { get; set; }

    public string? CoverBrodSize { get; set; }

    public float? CoverBrodLength { get; set; }

    public int? CoverBrodQty { get; set; }

    public float? CoverBclearance { get; set; }

    public float? CoverBrodGauge { get; set; }

    public int? CoverBnutQty { get; set; }

    public string? ScreensMaterial { get; set; }

    public float? ScreensWidth { get; set; }

    public float? ScreensLength { get; set; }

    public int? ScreensQty { get; set; }

    public string? DvcorkMaterial { get; set; }

    public float? DvcorkGauge { get; set; }

    public float? DvcorkWidth { get; set; }

    public float? DvcorkLength { get; set; }

    public string? ConsDvmaterial { get; set; }

    public string? ConsDvposition { get; set; }

    public float? ConsDvx { get; set; }

    public float? ConsDvy { get; set; }

    public float? ConsDvdia { get; set; }

    public string? Paint { get; set; }

    public string? Primer { get; set; }

    public string? Thinners { get; set; }

    public float? HlductPitch { get; set; }

    public float? WastePercentage { get; set; }

    public float? RPerc { get; set; }

    public float? XPerc { get; set; }

    public float? ZPerc { get; set; }

    public float? RogowskiConstant { get; set; }

    public double? Dove2Height { get; set; }

    public double? Dove2Length { get; set; }

    public double? Dove2Width { get; set; }

    public int? Dove2Qty { get; set; }

    public string? Dove2Shape { get; set; }

    public double? Dove2InnerWidth { get; set; }

    public double? Dove2OuterWidth { get; set; }

    public int? Dove2RadialQty { get; set; }

    public float? Dove2Stack { get; set; }

    public bool? Dove2Flip { get; set; }

    public string? Dovetail2Material { get; set; }

    public bool? HlspacersCustom { get; set; }

    public double? HlductHeight { get; set; }
    ...
    public float? ScreenLength { get; set; }

    public int? ScreenAfterWraps { get; set; }

    public string? HlwrapsBeforeAfter { get; set; }

    public string? ScreenLeadsMaterial { get; set; }

    public float? ScreenLeadsLength { get; set; }

    public int? ScreenLeadsQty { get; set; }

    public string? ScreenLeadsPos { get; set; }

    public float? HotRise { get; set; }

    public int? ScreenQtyPerCoil { get; set; }

    public float? HlductCoilLength { get; set; }

    public int? HlductCoilsPerLeg { get; set; }

    public float? HlinsCoilLength { get; set; }

    public int? HlinsCoilsPerLeg { get; set; }

    public float? EndwrapsCoilLength { get; set; }

    public float? FinTapeCoilLength { get; set; }

    public float? FinPaperCoilLength { get; set; }

    public int? EndWrapsCoilsPerLeg { get; set; }

    public int? FinTapeCoilsPerLeg { get; set; }

    public int? FinPaperCoilsPerLeg { get; set; }

    public int? HlwrapsMode { get; set; }

    public int? ScreenMode { get; set; }

    public int? HlspacersMode { get; set; }

    public int? EndWrapsMode { get; set; }

    public int? FinTapeMode { get; set; }

    public int? FinPaperMode { get; set; }

    public float? ClassTemp { get; set; }

    public string? Duty { get; set; }

    public bool? ZpercLock { get; set; }

    public float? PowerFreqMv { get; set; }

    public float? PowerFreqLv { get; set; }

    public int? HlductLayers { get; set; }

    public string? BuchholzFlangesMaterial { get; set; }

    public bool? Auto { get; set; }

    public float? RiseMargin { get; set; }

    public float? TankRiseStandard { get; set; }

    public float? HighAmbientCorrection { get; set; }

    public float? AltitudeCorrection { get; set; }
}
