...
public partial class DesignBobbins
{
    ...
    public string? LeadPosOnBobbin { get; set; }

    public float? FormerCoilLength { get; set; }

    public int? FormerCoilsPerLeg { get; set; }

    public int? FormerMode { get; set; }
}
